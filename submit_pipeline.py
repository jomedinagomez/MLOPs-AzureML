...
def main():
    ...
    ml_client = MLClient(
        ...
        resource_group_name="rgamlcc001",
    ...
    try:
        # Load the pipeline from YAML using the correct method
        with open(pipeline_file, 'r') as f:
            pipeline_yaml = yaml.safe_load(f)
        
        # Create a Job from the YAML content
        pipeline_job = Job._from_dict(pipeline_yaml)
