...
Airflow task
  ...
  -> load the approved pipeline generated by 05_submit_scoring_pipeline.ipynb
...
The workshop notebook writes the scorer, component YAML, and pipeline YAML under
`outputs/generated/h2o_customer/batch/`. Promote an approved, immutable copy of
those generated artifacts into the production Airflow release package; do not
reconstruct the graph independently in the DAG.
